...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post :create, practice: { n_goal: @practice.n_goal, t_description: @practice.t_description, t_name: @practice.t_name }
    end
  ...
  test "should update practice" do
    patch :update, id: @practice, practice: { n_goal: @practice.n_goal, t_description: @practice.t_description, t_name: @practice.t_name }
    assert_redirected_to practice_path(assigns(:practice))
  end
