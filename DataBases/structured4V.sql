...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2016 a las 05:06:37
...
INSERT INTO `practices` (`id`, `t_name`, `t_description`, `n_goal`, `created_at`, `updated_at`) VALUES
(1, 'alguna', 'asdfadsf', 2, '2016-05-02 19:29:10', '2016-05-02 19:29:10');
...
INSERT INTO `projects` (`id`, `t_name`, `created_at`, `updated_at`) VALUES
(1, 'Primer proyecto', '2016-05-02 19:19:08', '2016-05-02 19:19:08'),
(2, 'algun proyecto', '2016-05-02 19:22:03', '2016-05-02 19:22:03');
...
INSERT INTO `steps` (`id`, `t_description`, `n_practice`, `n_yestStep`, `n_noStep`, `t_typeStep`, `n_rol`, `user_id`) VALUES
(0, 'algosql', 1, 4, 5, 0x36, 7, 1),
(1, 'esta es la descripcion cam', 2, 1, 1, 0x017461726561, 2, NULL);
